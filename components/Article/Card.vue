...
import type { MarkdocFile } from '~/server/markdoc'
...
const tags = computed((): string[] => {
  return props.article.frontmatter.tags ?? []
})
const src = computed(() => `/images/blog/${props.article.slug}-icon.webp`)
</script>

<template>
  <div class="flex items-center relative group gap-x-6">
    <div>
      <AppImg :src="src" :alt="article.frontmatter.title" class="w-20 h-20 object-contain" />
      <div class="flex">
