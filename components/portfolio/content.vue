  ...
  >
    <div class="relative px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      >
        <div>
          <h2
            class="font-sans text-base font-semibold tracking-wide text-primary-600-600 dark:text-primary-600-400 uppercase"
          >
      ...
      <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
        <div class="relative lg:row-start-1 lg:col-start-2">
          ...
          <div
            v-if="markdown.attributes?.picture"
        ...
        <div class="mt-8 lg:mt-0">
          <div
            class="mx-auto mt-5 prose prose-primary-600 dark:prose-invert lg:max-w-none lg:row-start-1 lg:col-start-1"
          >
