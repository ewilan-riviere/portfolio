    ...
    <div class="container relative z-30 h-screen">
      <div class="flex flex-col items-center justify-center lg:flex-row center-full w-full">
        <div class="rounded-full border-2 border-white shadow-xl">
          <img src="/images/ewilan-riviere.webp" class="h-48 rounded-full sm:h-56" alt="author">
        </div>
        <div class="pt-8 sm:pt-10 lg:pl-8 lg:pt-0 text-center lg:text-left">
          ...
          <app-social class="flex justify-center lg:justify-start space-x-1 lg:space-x-3 mt-5" />
        </div>
      </div>
    </div>
  </div>
