...
<template>
  <section v-if="toast"
    ...
    :class="bgColor">
    <span class="absolute inset-x-0 bottom-0 h-1 bg-primary-500 dark:bg-primary-600 animate-life" />
    <div class="p-4">
      <div class="flex items-start">
        <div class="shrink-0">
          <svg-icon :name="toast.type ? `toast-${toast.type}` : 'information'" :class="color" class="h-6 w-6" />
        </div>
