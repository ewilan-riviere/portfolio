...
<template>
  <spotlight-layout-page title="Title" description="Desc">
    <div class="space-y-20">
      <section aria-labelledby=":r8:" class="md:border-l md:border-zinc-100 md:pl-6 md:dark:border-zinc-700/40">
        <div class="grid max-w-3xl grid-cols-1 items-baseline gap-y-8 md:grid-cols-4">
          <h2 id=":r8:" class="text-sm font-semibold text-zinc-800 dark:text-zinc-100">
            Workstation
            ...
            <ul role="list" class="space-y-16">
              <li class="group relative flex flex-col items-start">
                ...
                </h3><p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
      ...
      </section><section aria-labelledby=":r9:" class="md:border-l md:border-zinc-100 md:pl-6 md:dark:border-zinc-700/40">
        <div class="grid max-w-3xl grid-cols-1 items-baseline gap-y-8 md:grid-cols-4">
      ...
      </section><section aria-labelledby=":ra:" class="md:border-l md:border-zinc-100 md:pl-6 md:dark:border-zinc-700/40">
        <div class="grid max-w-3xl grid-cols-1 items-baseline gap-y-8 md:grid-cols-4">
          <h2 id=":ra:" class="text-sm font-semibold text-zinc-800 dark:text-zinc-100">
            Design
          </h2><div class="md:col-span-3">
            <ul role="list" class="space-y-16">
              <li class="group relative flex flex-col items-start">
      ...
      </section><section aria-labelledby=":rb:" class="md:border-l md:border-zinc-100 md:pl-6 md:dark:border-zinc-700/40">
        <div class="grid max-w-3xl grid-cols-1 items-baseline gap-y-8 md:grid-cols-4">
          <h2 id=":rb:" class="text-sm font-semibold text-zinc-800 dark:text-zinc-100">
            Productivity
          </h2><div class="md:col-span-3">
            <ul role="list" class="space-y-16">
              <li class="group relative flex flex-col items-start">
