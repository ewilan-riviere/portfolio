...
.code-group {
  /* @apply surface-border; */
  @apply overflow-hidden rounded-lg border border-gray-700;
...
.code-group-content {
  .preview-canvas {
    @apply z-0 my-0 overflow-x-auto rounded-bl-lg rounded-br-lg p-4 leading-normal bg-gray-800 text-gray-200;
