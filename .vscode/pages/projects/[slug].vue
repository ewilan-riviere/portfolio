...
async function fetchReadme(): Promise<string | undefined> {
  ...
  const html = await useMarkdownHtml(readmeText)
      ...
      >
        ...
        >
          <app-img
            ...
            class="w-full max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 object-contain h-52 object-cover"
          />
